...
def test_nuke_requires_confirmation_before_execution():
...
def test_next_position_id_is_unique_under_concurrency():
    async def run_test() -> None:
...
def test_mode_and_pairs_commands_render_expected_output():
    async def run_test() -> None:
        mock_update = Mock()
