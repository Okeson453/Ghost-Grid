...
CVD_RING_BUFFER_SIZE: int = 200  # Minutes of CVD history (EMA + Z-score)
TICK_PIPE_INTERVAL_MS: int = 200  # Tick snapshot interval (ms)
...
# Layer 1: profit trigger -> arms trailing stop
PROFIT_TRIGGER_USD: float = 1.50  # $1.50 unrealised profit -> trail armed
# Layer 2: Trailing stop execution
TRAIL_FLOOR_USD: float = (
    0.75  # Minimum trail distance floor ($0.75). ATR-adaptive usually larger
)
...
NUCLEAR_LATENCY_THRESHOLD_MS: float = 500.0  # Execution latency anomaly (ms)
NUCLEAR_CORRELATION_SPIKE: float = 0.80  # Avg pair correlation ceiling
